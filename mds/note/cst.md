...
```
7. 公告模块做了一部分，先暂停
8. 登录内蒙航信服务号，获取appid等信息

## 2017-06-28
1. 修改财税服务微信中获取openid的方式，根据不同的服务号得到不同的appid
2. 登录财税通会员服务微信平台，修改菜单路径
3. 配置内蒙古航信会员服务微信菜单和业务服务器
4. 财税通服务端，自查情况统计，添加所属省份和区域或运营商的检索条件，修改导出excel
5. 财税通服务端，模块点击明细统计、模块点击率统计，添加所属省份和区域或运营商的检索条件，修改导出excel

## 2017-06-29
1. 部署财税通服务端
2. 将财税服务接口项目链接的数据库改为正式数据库
3. 财税服务接口中添加下载安卓端app的固定地址

## 2017-06-30
1. 修改财税通客户端生成会员和查询页面每天记录数为100条
2. 生成会员时添加条件验证
